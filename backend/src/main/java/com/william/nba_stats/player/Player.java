...
public class Player {
    ...
    public Player(Long id, Integer rk, String name, Integer age, String team, String pos, Integer g,
                  Integer gs, Double mp, Double fg, Double fga, Double fg_pct, Double threep,
                  Double threepa, Double threep_pct, Double twop, Double twopa, Double twop_pct,
                  Double efg_pct, Double ft, Double fta, Double ft_pct, Double orb, Double drb, Double trb,
